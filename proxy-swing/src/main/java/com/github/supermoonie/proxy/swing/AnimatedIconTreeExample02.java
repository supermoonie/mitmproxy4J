 ...
 * @since 2020/11/27
 */
public class AnimatedIconTreeExample02 extends JFrame {

    public AnimatedIconTreeExample02() {
...
//        Icon icon = new ImageIcon(url);
        nodes[2].setIcon(new ImageIcon(url));
        nodes[3].setIcon(new ImageIcon(url));
        nodes[5].setIcon(new ImageIcon(url));
        nodes[6].setIcon(new ImageIcon(url));
        nodes[7].setIcon(new ImageIcon(url));
    ...
    public static void main(String args[]) {
        ...
        AnimatedIconTreeExample02 frame = new AnimatedIconTreeExample02();
