 ...
 * @date 2020-11-19
 */
public class TreeItemCopyHandler implements EventHandler<KeyEvent> {
    ...
    public TreeItemCopyHandler(TabPane tabPane, Tab structureTab, TreeView<FlowNode> treeView, ListView<FlowNode> listView) {
