...
public class CellUtils {
    ...
    private final static StringConverter<?> DEFAULT_STRING_CONVERTER = new StringConverter<>() {
        @Override
    ...
    private final static StringConverter<?> DEFAULT_TREE_ITEM_STRING_CONVERTER =
    ...
    public static <T> StringConverter<TreeItem<T>> defaultTreeItemStringConverter() {
        return (StringConverter<TreeItem<T>>) DEFAULT_TREE_ITEM_STRING_CONVERTER;
    }
